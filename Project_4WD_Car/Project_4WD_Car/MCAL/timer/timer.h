...
typedef enum EN_TimerError_t{
	TIMER_OK,TIMER_INVALID_MODE, TIMER_INVALID_PRESCALAR, TIMER_INVALID_DELAY, TIMER_INVALID_SETINIT, TIMER_INVALID_OVF, TIMER_INVALID_T0PWM, TIMER_INVALID_INIT
}EN_TimerError_t;
...
/*Timer2 pres calling
(TIMER2_STOP 0, TIMER2_NO_PRESCALLING 1, TIMER2_SCALER_8 2, TIMER2_SCALER_32 3,
...
EN_TimerError_t TIMER_timer2SetInitial(uint8_t intial_value);
